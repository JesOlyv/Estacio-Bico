...
comando1 = " CREATE TABLE tblUsers (codUser INTERGER NOT NULL, name TEXT NOT NULL, phone INTERGER, address TEXT NOT NULL, email TEXT NOT NULL, age INTERGER NOT NULL, PRIMARY KEY(codUser));"
